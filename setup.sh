...
echo "Background skills (design-system, document-designer, universal-coding-standards,"
echo "  architecture-patterns, dev-workflow, enterprise-secure-ai-engineering,"
echo "  brainstorm-artifact) auto-load."
echo "User skills: /canva-designer, /desktop-ui-designer, /pyqt6-ui-debugger, /python-code-reviewer"
echo ""
